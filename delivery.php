                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($query)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="container">
                                                <input type="button" name="edit" value="แก้ไขประเภทจัดส่งสินค้า" id="<?php echo $row["Delivery_ID"]; ?>" class="btn btn-info  btn-sm  edit_data-Delivery" />
            ...
            <div class="container-fluid">
                <form action="php/insert.php" method="post">
                    <div class="form-row mx-sm-3 mb-2">
                        ...
                        <input type="text" class="form-control mb-2 my-2 " id="namedelivery" name="namedelivery" placeholder="ชื่อประเภทการจัดส่งสินค้า" maxlength="50" required>

                        <div class="form-group row py-2">
                            <label for="exampleFormControlInput1" class="col-6 py-4">ค่าจัดสินค้า</label>
                            <input type="number" class="form-control mb-2 my-2 col-4" id="moneydelivery" name="moneydelivery" placeholder="จำนวนเงิน" maxlength="2" min="1" required>
                            <label for="exampleFormControlInput1" class="col-2 py-4">บาท</label>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-success btn-lg  float-right  mb-2  mx-3 my-1 px-5 " id="insertdelivery" name="insertdelivery">บันทึกประเภทการจัดส่งสินค้า</button>
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="Delivery" action="php/update.php">
                        ...
                        <input type="text" name="Deliveryname" id="Deliveryname" class="form-control" maxlength="70" required />
                        <br />
                        <label>ค่าจัดสินค้า</label>
                        <input type="number" name="Price" id="Price" class="form-control" maxlength="5" required min="0" />
                ...
                <div class="modal-footer py-2">
                    ...
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <div>
                        <input type="submit" name="updateDelivery" id="updateDelivery" value="อัพเดท" class="btn btn-success " />
                    </div>
                    <div class="py-3"></div>
                    </form>
                </div>
