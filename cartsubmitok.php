                        ...
                        <form action="php\insert.php" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="nameproduct" name="nameproduct" placeholder="ชื่อนามสกุล" value="<?php echo $_POST['nameproduct'] ?>" disabled>
                                    </div>
                                </div>
                                <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="addressuser2" name="addressuser2" rows="5" placeholder="ที่อยู่ในการส่งสินค้า" disabled><?php echo $address ?>
                            ...
                            */
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="numberphone" name="numberphone" placeholder="เบอร์โทรติดต่อ" value="<?php echo $_POST['numberphone'] ?>" disabled>
                                    </div>
                                </div>

                                <div class=" form-group row">
                                    <label for="exampleFormControlSelect1" class="py-2 col-sm-2">เลือกการจัดส่ง</label>
                                    <select class="form-control col-sm-5 mx-3" id="Delivery2" name="Delivery2" required disabled>
                                ...
                                <input type="hidden" name="nameusersend" id="nameusersend" value="<?php echo $_POST['nameproduct'] ?>">
