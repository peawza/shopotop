                        ...
                        <form action="?act=update" method="post">
                                        ...
                                        <div class="col-12 col-sm-12 text-sm-center col-md-4 text-md-right row">
                                            ...
                                            <div class="col-4 col-sm-4 col-md-4">
                                                <div class="quantity">
                                                    ...
                                                    <input type="number" step="1" max="<?php echo $values["item_Balance"] ?>" min="1" value="<?php echo $values["item_quantity"] ?>" name="quantity<?php echo $i ?>" id="<?php echo $values["item_id"] ?>" title="Qty" class="qty" size="6">
                            ...
                            <div class="row">
                                <div class="col float-left text-left">
                                    <button type=" submit" name="updatecart" id="updatecart" value="updatecart" class="btn btn-outline-secondary  btn-sm">
                                        คำนวนรายการสินค้าใหม่
                                    </button>

                        </form>
                        <button type=" submit" name="deletecart" id="deletecart" value="deletecart" class="btn btn-outline-secondary  btn-sm">
                            ลบสินค้าทั้งหมด
                        </button>
