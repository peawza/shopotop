    ...
    <div class="container py-3">
        ...
        <div class="py-3">
            ...
            <form name="frmSearch" method="post" action="<?php echo $_SERVER['SCRIPT_NAME']; ?>" <div class="form-group row">
                ...
                <div class="col-7">
                    <input type="text" class="form-control" id="txtKeyword" name="txtKeyword" placeholder="ค้นหาชื่อลูกค้า" maxlength="50" value="<?php echo $strKeyword; ?>">
                </div>
                <div class="col-3">
                                    ...
                                    <td>
                                        <div class="mx-auto text-center">
                                            ...
                                            <form action="php\update.php" method="get">
                                                ...
                                                <input class="form-control form-control-sm " type="text" name="Packagenumber" id="Packagenumber" placeholder="ใส่หมายเลขพัสดุ" required>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="php/update.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <button type="submit" name="submitordersalesTransfermoney" id="submitordersalesTransfermoney" class="btn btn-primary" disabled>บันทึก</button>
                    </div>
                </form>
